...
<object type="text/html" data="{{ site.baseurl }}/SF_Plots/TimeSeries.html" width="800" height="400" style="border: none; padding: 0; width:100%; height:50vw"></object>
...
<object type="text/html" data="{{ site.baseurl }}/SF_Plots/scatterplot_layer.html"  width="800" height="400" style="border: none; padding: 0; width=100%; height=50vw"></object>
