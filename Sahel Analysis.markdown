...
<body>
    ...
    <object id="plot2" type="text/html" data="{{ site.baseurl }}/targetTypeNorm.html" class="bokeh-plot" width="1400" height="400" style="display: none; border: none; padding: 0; width:70%; height:40vw"></object>
    <object id="plot3" type="text/html" data="{{ site.baseurl }}/weaponTypeNorm.html" class="bokeh-plot" width="1200" height="400" style="display: none; border: none; padding: 0; width:30%; height:40vw"></object>
